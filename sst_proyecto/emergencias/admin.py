...
class EmergenciaAdmin(admin.ModelAdmin):
    list_display = ["tipo", "reportada_por", "estado", "fecha_hora_reporte", "personas_afectadas"]
...
class BrigadaEmergenciaAdmin(admin.ModelAdmin):
    list_display = ["usuario", "especializacion", "nivel_certificacion", "activo", "disponible"]
...
class ContactoExternoAdmin(admin.ModelAdmin):
    list_display = ["nombre", "entidad", "tipo", "telefono_principal", "activo"]
