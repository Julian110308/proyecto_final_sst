...
class BrigadaEmergenciaSerializer(serializers.ModelSerializer):
    ...
    especializacion_display = serializers.CharField(source="get_especializacion_display", read_only=True)
    nivel_certificacion_display = serializers.CharField(source="get_nivel_certificacion_display", read_only=True)
