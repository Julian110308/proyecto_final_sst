...
class Geocerca(models.Model):
    ...
    radio_metros = models.IntegerField(
        default=200, validators=[MinValueValidator(1)], help_text="Radio en metros (mínimo 1 metro)"
    )
    ...
    def punto_esta_dentro(self, latitud, longitud):
        ...
        """
        distancia = calcular_distancia(self.centro_latitud, self.centro_longitud, latitud, longitud)
