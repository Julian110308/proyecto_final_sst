...
class IncidenteAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Información Básica", {"fields": ("titulo", "descripcion", "tipo", "gravedad", "estado")}),
        ("Ubicación y Fecha", {"fields": ("ubicacion", "fecha_incidente", "fecha_reporte")}),
        ("Responsables", {"fields": ("reportado_por", "asignado_a")}),
        ("Evidencia y Acciones", {"fields": ("foto", "acciones_tomadas", "fecha_resolucion")}),
    )
