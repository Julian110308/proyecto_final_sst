...
class ExcelReporteGenerator:
    ...
    def generar_reporte_aforo(datos):
        ...
        resumen = [
            ...
            [
                ...
                f"{datos['tiempo_promedio_permanencia_minutos']} min"
                if datos["tiempo_promedio_permanencia_minutos"]
                else "N/A",
            ],
        ]
        ...
        if datos["aforo_por_rol"]:
            ...
            ExcelReporteGenerator._aplicar_estilo_header(
                ws, 15, 2, PatternFill(start_color="2ECC71", end_color="2ECC71", fill_type="solid")
            )
        ...
        ws.cell(row=last_row, column=1, value=f"Generado el: {datetime.now().strftime('%d/%m/%Y %H:%M:%S')}")
    ...
    def generar_reporte_incidentes(datos):
        ...
        resumen = [
            ...
            [
                ...
                f"{datos['tiempo_promedio_respuesta_minutos']} min"
                if datos["tiempo_promedio_respuesta_minutos"]
                else "N/A",
            ],
        ]
        ...
        ExcelReporteGenerator._aplicar_estilo_header(
            ws, 5, 2, PatternFill(start_color="E74C3C", end_color="E74C3C", fill_type="solid")
        )
        ...
        if datos["por_tipo"]:
            ...
            ExcelReporteGenerator._aplicar_estilo_header(
                ws, 14, 2, PatternFill(start_color="E67E22", end_color="E67E22", fill_type="solid")
            )
        ...
        if datos["por_estado"]:
            ...
            ExcelReporteGenerator._aplicar_estilo_header(
                ws, current_row + 1, 2, PatternFill(start_color="9B59B6", end_color="9B59B6", fill_type="solid")
            )
            ...
            ExcelReporteGenerator._aplicar_estilo_datos(
                ws, current_row + 2, current_row + 1 + len(datos["por_estado"]), 2
            )
    ...
    def generar_reporte_asistencia(datos):
        ...
        ExcelReporteGenerator._aplicar_estilo_header(
            ws, 5, 2, PatternFill(start_color="16A085", end_color="16A085", fill_type="solid")
        )
        ...
        ExcelReporteGenerator._aplicar_estilo_header(
            ws, 12, len(headers), PatternFill(start_color="27AE60", end_color="27AE60", fill_type="solid")
        )
    ...
    def generar_reporte_seguridad(datos):
        ...
        ExcelReporteGenerator._aplicar_estilo_header(
            ws, 5, 2, PatternFill(start_color="34495E", end_color="34495E", fill_type="solid")
        )
        ExcelReporteGenerator._aplicar_estilo_datos(ws, 6, 10, 2)
        ...
        if datos["equipamiento_por_tipo"]:
            ...
            ExcelReporteGenerator._aplicar_estilo_header(
                ws, 14, 3, PatternFill(start_color="2980B9", end_color="2980B9", fill_type="solid")
            )
        ...
        if datos["emergencias_por_tipo"]:
            ...
            ws.cell(row=current_row + 1, column=2, value="Total")
            ExcelReporteGenerator._aplicar_estilo_header(
                ws, current_row + 1, 2, PatternFill(start_color="C0392B", end_color="C0392B", fill_type="solid")
            )
            ...
            ExcelReporteGenerator._aplicar_estilo_datos(
                ws, current_row + 2, current_row + 1 + len(datos["emergencias_por_tipo"]), 2
            )
    ...
    def generar_reporte_emergencias(datos):
        ...
        ExcelReporteGenerator._aplicar_estilo_header(
            ws, 5, 2, PatternFill(start_color="C0392B", end_color="C0392B", fill_type="solid")
        )
        ExcelReporteGenerator._aplicar_estilo_datos(ws, 6, 10, 2)
        ...
        if datos.get("emergencias"):
            ...
            headers = ["Fecha", "Tipo", "Estado", "Ubicación", "Reportado Por", "Tiempo Respuesta", "Afectados"]
            for j, header in enumerate(headers):
                ws.cell(row=14, column=j + 1, value=header)
