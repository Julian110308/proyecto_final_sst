...
class CSVReporteGenerator:
    ...
    def generar_reporte_aforo(datos):
        ...
        writer.writerow(["Tiempo Promedio Permanencia (min)", datos["tiempo_promedio_permanencia_minutos"] or "N/A"])
        writer.writerow([])
    ...
    def generar_reporte_incidentes(datos):
        ...
        writer.writerow(["Tiempo Promedio Respuesta (min)", datos["tiempo_promedio_respuesta_minutos"] or "N/A"])
        writer.writerow([])
    ...
    def generar_datos_crudos_asistencia(datos):
        ...
        # Solo datos crudos para análisis
        writer.writerow(
            ["nombre", "documento", "ficha", "dias_asistio", "dias_totales", "porcentaje_asistencia", "estado"]
        )
