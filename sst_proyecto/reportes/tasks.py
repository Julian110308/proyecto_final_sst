...
def generar_reportes_programados(self):
    ...
    from reportes.services import ReporteAforoService, ReporteIncidentesService, ReporteSeguridadService
    ...
    resultado = {"reportes_generados": reportes_generados, "errores": errores, "timestamp": timezone.now().isoformat()}
...
def generar_reporte_individual(tipo, formato, fecha_inicio_str, fecha_fin_str, ficha=None, usuario_id=None):
    ...
    try:
        ...
        buffer = generator_method(datos)  # noqa: F841
        ...
        if usuario:
            ...
            return {"success": True, "reporte_id": reporte.id, "tipo": tipo, "formato": formato}
