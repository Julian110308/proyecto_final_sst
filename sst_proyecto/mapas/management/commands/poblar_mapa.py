...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write("")
        self.stdout.write(self.style.SUCCESS("Mapa del Centro Minero SENA poblado correctamente."))
        self.stdout.write(
            self.style.SUCCESS("Accede a /mapas/ para ver el mapa interactivo o /mapas/plano/ para el plano.")
        )
