...
@rol_requerido('VIGILANCIA', 'ADMINISTRATIVO', 'INSTRUCTOR')
def visitantes_view(request):
    """
    Vista de Gestión de Visitantes
    PERMISOS: VIGILANCIA, ADMINISTRATIVO, INSTRUCTOR
    """
...
urlpatterns = [
    ...
    path('usuarios/', gestion_usuarios_view, name='gestion_usuarios'),
    path('perfil/', perfil_view, name='perfil'),
    path('visitantes/', visitantes_view, name='visitantes'),
